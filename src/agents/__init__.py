...
def build_agent_list(game: GameBenchmark, agent_kwargs: str, gen_kwargs: str, eos_to_cull: str) -> List[Agent]:
    ...
    if len(agents) > num_agents:
        message = f"Too many agents for this game. The maximum number of player agents for this game is {num_agents}"
        ...
        agents.extend([HFAgent(eos_to_cull=eos_to_cull, gen_kwargs=gen_kwargs, **agent_args)])
    return agents
